...
# CHUNKS = 11
# height_ = np.random.uniform(0, H/2, size=(CHUNKS+1,))
# initial_force_x = np.random.uniform(-INITIAL_RANDOM, INITIAL_RANDOM)
# initial_force_y = np.random.uniform(-INITIAL_RANDOM, INITIAL_RANDOM)
...
class LunarLander(gym.Env, EzPickle):
    ...
    def seed(self, seed=None):
        ...
        CHUNKS = 11
        self.height_ = self.np_random.uniform(0, H/2, size=(CHUNKS+1,))
        self.initial_force_x = self.np_random.uniform(-INITIAL_RANDOM, INITIAL_RANDOM)
        self.initial_force_y = self.np_random.uniform(-INITIAL_RANDOM, INITIAL_RANDOM)
        self.dispersion_constant = self.np_random.uniform(-1.0, +1.0)
        return [seed]
    ...
    def reset(self):
        ...
        #     self.np_random.uniform(-INITIAL_RANDOM, INITIAL_RANDOM)
        #     ), True)
        self.lander.ApplyForceToCenter((self.initial_force_x,self.initial_force_y),True)
    ...
    def step(self, action):
        ...
        side = (-tip[1], tip[0])
        dispersion = [self.dispersion_constant / SCALE for _ in range(2)]
